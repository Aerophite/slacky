...
func start(message globals.Message) error { // sentence, number of guesses
    ...
    gameIndex, _, _ := games.AddGame(Game{
            ...
            guessesRemaining,
            map[string]bool {"a": false, "b": false, "c": false, "d": false, "e": false, "f": false, "g": false, "h": false, "i": false, "j": false, "k": false, "m": false, "n": false, "o": false, "p": false, "q": false, "r": false, "s": false, "t": false, "u": false, "v": false, "w": false, "x": false, "y": false, "z": false},
            message.Channel,
            message.User,
            []globals.User{},
            "in-process"})
...
func stat(message globals.Message, gameIndex int, reply bool) error {
